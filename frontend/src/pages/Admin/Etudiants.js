    ...
    <div className="flex min-h-screen bg-white font-sans text-[#1A1D1F] relative">
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/20 backdrop-blur-[1px]">
          <div className="bg-white rounded-[20px] shadow-2xl p-8 w-[450px] flex flex-col items-center animate-fade-in">
            {/* Exclamation Icon */}
            ...
            <div className="flex space-x-5 w-full justify-center">
              <button 
                ...
                className="px-8 py-3 rounded-[10px] border border-[#E8E8E8] text-[#6F767E] text-[12px] font-[800] tracking-wider hover:bg-gray-50 transition-colors uppercase"
              >
                Annuler
              </button>
              <button 
                onClick={confirmDelete}
                className="px-8 py-3 rounded-[10px] bg-[#42A487] text-white text-[12px] font-[800] tracking-wider hover:bg-[#368f74] transition-colors shadow-sm uppercase"
              >
                Supprimer
              </button>
            </div>
      ...
      {/* Sidebar - Collapsed as in Design */}
      <aside className="w-20 border-r border-[#F0F0F0] flex flex-col items-center py-8 bg-white z-10">
        ...
        <nav className="flex-1 space-y-8">
          ...
          <SideIcon icon={<StudentIcon />} to="/admin/students" active />
      ...
      <main className="flex-1 bg-[#F4F4F4]/30 px-12 py-8">
        {/* Header - Fixed Profile Design */}
        <div className="flex justify-end items-center mb-10 space-x-8">
          <button className="text-[#6F767E] hover:text-black"><SearchIcon /></button>
          <button className="text-[#6F767E] relative"><BellIcon /></button>
          <div className="flex items-center space-x-3 pl-4 border-l border-[#F0F0F0]">
            ...
            <div className="w-10 h-10 rounded-full bg-[#FFBC99] flex items-center justify-center border-2 border-white shadow-sm overflow-hidden">
        ...
        {/* Title Section */}
        <div className="mb-8">
          <h2 className="text-[28px] font-[700] text-[#1A1D1F]">Étudiants</h2>
          <p className="text-[#6F767E] text-[13px]">Gérez les comptes des étudiants inscrits dans la plateforme.</p>
        </div>
                ...
                <tr key={student.id} className="hover:bg-[#F4F4F4]/20 transition-colors">
                  <td className="px-6 py-4">
                    <div className="flex items-center space-x-3">
                      <div className="w-9 h-9 rounded-full bg-[#EFEFEF] overflow-hidden flex items-center justify-center border border-white">
                        {student.img ? (
                      ...
                      <span className="text-[13px] font-[700] text-[#1A1D1F]">{student.name}</span>
                    </div>
                  </td>
                  ...
                  <td className="px-6 py-4 text-right">
                    <button 
                      ...
                      className="text-[#6F767E] hover:text-red-500 transition-colors"
                    >
                      <TrashIcon />
                    </button>
                  </td>
