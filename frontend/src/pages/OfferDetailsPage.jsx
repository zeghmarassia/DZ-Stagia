            ...
            <div className="bg-white rounded-[24px] border border-gray-100 p-8 shadow-sm">
              <div className="flex justify-between items-start mb-6">
                <div className="flex items-center space-x-5">
                  ...
                  <div>
                    <h1 className="text-[24px] font-[800] text-[#111827]">Développeur Full Stack</h1>
                    <div className="flex items-center space-x-3 mt-1">
                      <span className="text-[#4fa797] text-[14px] font-bold">Digital Solutions</span>
                      ...
                      <span className="text-gray-300">•</span>
                      <span className="text-gray-400 text-[13px] font-medium italic text-nowrap">Il y a 10 heures</span>
                    </div>
                  </div>
                </div>
                <span className="bg-[#4fa797]/10 text-[#4fa797] px-4 py-1.5 rounded-full text-[11px] font-[800]">Stage</span>
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
                ...
                />
                <InfoBadge 
                  icon={<svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M22 10L12 5 2 10l10 5 10-5z" /><path d="M6 12v5c3 3 9 3 12 0v-5" /></svg>} 
                  label="Bac +3 minimum" 
                />
                <InfoBadge 
            ...
            <div className="bg-white rounded-[24px] border border-gray-100 p-8 shadow-sm space-y-8">
              ...
              <section>
                ...
                <ul className="space-y-3 text-gray-500 text-[15px] font-medium">
                  <ListItem text="Développement de fonctionnalités front-end (React/Vue.js) et back-end (Node.js/Python)." />
                  <ListItem text="Participation aux réunions de conception technique et d'architecture." />
                  <ListItem text="Rédaction de tests unitaires et fonctionnels pour assurer la qualité du code." />
                  <ListItem text="Correction de bugs et optimisation des performances de l'application." />
                  <ListItem text="Collaboration avec l'équipe produit pour comprendre les besoins des utilisateurs." />
                </ul>
              </section>
              ...
              <section>
                ...
                <ul className="space-y-3 text-gray-500 text-[15px] font-medium">
                  <ListItem text="Étudiant(e) en Informatique, génie logiciel ou équivalent (fin d'études ou stage PFE)." />
                  <ListItem text="Connaissance des langages web modernes : HTML5, CSS3, JavaScript (ES6+)." />
                  <ListItem text="Première expérience (projets académiques ou personnels) avec un framework JS (React, Angular ou Vue)." />
                  <ListItem text="Notions de bases de données (SQL or NoSQL) et de versioning avec Git." />
                  <ListItem text="Esprit d'équipe, curiosité et envie d'apprendre." />
                  <ListItem text="Bon niveau de français et anglais technique." />
                </ul>
              </section>
              ...
              <section>
                ...
                <ul className="space-y-3 text-gray-500 text-[15px] font-medium">
                  <ListItem text="Un environnement de travail stimulant et bienveillant." />
                  <ListItem text="Possibilité d'embauche à la fin du stage." />
                  <ListItem text="Mentorat personnalisé par des développeurs expérimentés." />
                  <ListItem text="Horaires flexibles et possibilité de télétravail partiel." />
                </ul>
              </section>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-[24px] border border-gray-100 p-8 shadow-sm">
              ...
              <div className="flex items-center space-x-4 mb-4">
                <div className="w-12 h-12 bg-gray-50 rounded-lg flex items-center justify-center font-bold text-gray-400 border border-gray-100">DS</div>
                <div>
                  <h4 className="font-[800] text-[15px]">Digital Solutions</h4>
                  <p className="text-[12px] text-gray-400 font-bold">Services IT & Consulting</p>
                </div>
              </div>
